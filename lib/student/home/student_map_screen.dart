  ...
  try {
    ...
    setState(() {
      querySnapshot.docs.forEach((doc) {
        ...
        BusRouteModel bus = BusRouteModel.fromFirestore(doc.data() as Map<String, dynamic>, doc.id);
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: selectedRouteId == route.id ? const Color.fromRGBO(76, 175, 80, 1).withOpacity(0.4) : Colors.blue.withOpacity(0.0),
...
print("=====================================${docId}");
      ...
      Color color = (selectedRouteId == docId) ? Colors.blueAccent :Colors.grey.withOpacity(0.6) ;
      polylines.add(Polyline(
        polylineId: PolylineId(docId), // Use docId as polyline ID for uniqueness
        color: color,
        width: 5,
